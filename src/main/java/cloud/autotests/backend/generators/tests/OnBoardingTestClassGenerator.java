...
//        testMethods.append(generateHeaderTestMethods(order, htmlDom));
    ...
    public static String generateConsoleErrorTestMethod(String url) {
        String testMethodDescription = "Autogenerated, because test steps contain text 'http...'";
        ...
        String testSteps = generateOpenPageStep(url) + generateCheckConsoleErrorStep();
